...
const Navbar = memo(function Navbar() {
  ...
  return (
    <>
          ...
          <div className="flex items-center justify-between h-14 md:h-16">
            ...
            >
              ...
              <span className={`font-display text-lg md:text-xl font-semibold tracking-tight transition-colors duration-300 ${
                isScrolled ? 'text-forest-900' : 'text-forest-900'
              }`}>
                Al Arabia
              </span>
            </Link>
            ...
            <button
              onClick={toggleMenu}
              className={`md:hidden relative w-10 h-10 flex items-center justify-center rounded-full transition-colors duration-200 ${
      ...
      <div
        className={`fixed inset-0 z-40 md:hidden transition-all duration-500 ease-out-expo ${
      ...
      >
        ...
        {/* Menu Panel */}
        <div
          className={`absolute top-0 right-0 w-full max-w-sm h-full bg-white shadow-prominent transform transition-transform duration-500 ease-out-expo ${
          ...
          <nav className="p-5">
            ...
            <div className="mt-8 pt-8 border-t border-gray-100">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center gap-3 w-full px-6 py-4 bg-forest-900 text-white text-lg font-medium rounded-2xl transition-all duration-300 hover:bg-forest-700"
              >
